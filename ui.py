...
##        message.grid(column=0, row=3, padx=10, pady=10)
        if str_label == 'bacterial':
            ...
            r = tk.Label(text='Click below for remedies...', background="lightgreen", fg="Brown", font=("", 15))
            r.grid(column=0, row=5, padx=10, pady=10)
            button3 = tk.Button(text="Remedies", command=m)
            button3.grid(column=0, row=6, padx=10, pady=10)
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='E:/P_2020/PlantDisease-master/PlantDisease-master/test/test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "E:/P_2020/PlantDisease-master/PlantDisease-master/testpicture"
    print(fileName)
